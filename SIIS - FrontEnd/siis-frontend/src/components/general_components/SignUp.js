...
class SignUp extends Component {
  ...
  handleSubmit = e => {
    ...
    if (this.state.password1 !== this.state.password2) {
      ...
      axios
        .post("http://localhost:3000/api/student/", studentMapper)
        .then(result => {
          axios
            .post("http://localhost:3000/api/auth/user", authMapper)
            .then(result => {
    ...
    return (
      <div className="FormCenter">
        <form className="FormFields" onSubmit={this.handleSubmit}>
          ...
          <div className="FormField">
            <label className="FormField__Label" htmlFor="nic">
              NIC (Optional)
            </label>
            <input
              type="text"
          ...
          <div className="FormField">
            <label className="FormField__Label" htmlFor="password1">
              Username
            </label>
            <input
              type="username"
          ...
          <div className="FormField">
            ...
            <NavLink exact to="/" className="FormField__Link">
